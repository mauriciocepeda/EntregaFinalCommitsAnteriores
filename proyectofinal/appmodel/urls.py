...
from appmodel.views import login_request, register, editar_perfil, agregar_avatar, borrar_avatar
from appmodel.views import about_me
...
#---------------Login-Logout-Registro------------------------------------------
    ...
    path('borrar_avatar',borrar_avatar, name='borrar_avatar'),
#---------------About me------------------------------------------
